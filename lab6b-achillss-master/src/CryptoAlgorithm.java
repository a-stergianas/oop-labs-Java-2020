 ...
 * Algorithm1 & Algorithm 2. Τροποποιήστε κατάλληλα το παρακάτω κομμάτι κώδικα ώστε να υλοποιεί ένα interface που
 * να αναπαριστά έναν αλγόριθμο. Κάθε αλγόριθμος κρυπτογράφησης έχεις μέθοδο κρυπτογράφησης και αποκτυπτογράφησης.
 *
 ...
 * code according in order to implement an interface that will represent a ciphering algorithm. Each ciphering algorithm
